package com.ravi.jupudi.employee.controller;
...
import com.ravi.jupudi.employee.service.EmployeeService;
...
public class EmployeeController {
	...
	/*@RequestMapping(value = "/{id}", method = RequestMethod.GET)
	public ResponseEntity<Void> getEmployeeDetails(@PathVariable("id") Long id) {
		Employee employee = empService.getById(id);
		if (employee == null) {
			logger.debug("Employee with id " + id + " does not exists");
			return new ResponseEntity<Void>(HttpStatus.NOT_FOUND);
